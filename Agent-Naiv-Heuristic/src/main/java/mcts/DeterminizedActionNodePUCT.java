...
public class DeterminizedActionNodePUCT extends AbstractPuctActionNode<DeterminizedActionNodePUCT> {
    ...
    public float getSelectionScore() {
        ...
        AgentNaivHeuristic heuristicAgent = (AgentNaivHeuristic) agent;
    ...
    public float simulate(State state) {
        AgentNaivHeuristic heuristicAgent = (AgentNaivHeuristic) agent;
        return averageHeuristicRollout(state, heuristicAgent.rolloutCount(), (rolloutState, actions) -> chooseRolloutAction(rolloutState, actions, heuristicAgent));
    }

    private int chooseRolloutAction(State state, ActionSet actions, AgentNaivHeuristic heuristicAgent) {
